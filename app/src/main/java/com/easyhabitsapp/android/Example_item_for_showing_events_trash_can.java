...
public class Example_item_for_showing_events_trash_can {
    ...
    public Example_item_for_showing_events_trash_can(int drawable_resource, String event_name, String event_description,int drawable_trash_can, String event_time, String event_am_or_pm,String date){
