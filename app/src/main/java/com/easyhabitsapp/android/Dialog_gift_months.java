...
public class Dialog_gift_months extends DialogFragment {
    private View mview;
    private int gift;
    private boolean ready_to_dismiss = false;

    public Dialog_gift_months(int gift) {
        this.gift = gift;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.dialog_gift_months, container);
        this.mview = rootView;
        ok_button_listen();
        if (getDialog() != null) {
